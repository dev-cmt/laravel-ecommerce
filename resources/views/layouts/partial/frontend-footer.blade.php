                                ...
                                <div class="tp-footer-contact">
                                    <div class="tp-footer-contact-item d-flex align-items-start">
                                        ...
                                        <div class="tp-footer-contact-content">
                                            <p><a
                                                href="https://template.wphix.com/cdn-cgi/l/email-protection#c5b6adaaa3bc85b6b0b5b5aab7b1eba6aaa8"><span
                                                class="__cf_email__"
                                                data-cfemail="97e4fff8f1eed7e4e2e7e7f8e5e3b9f4f8fa">[email&#160;protected]</span></a>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="tp-footer-contact-item d-flex align-items-start">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="tp-footer-copyright">
                                <p>© 2023 All Rights Reserved | HTML Template by <a href="index.html">ICON ISL</a>.</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="tp-footer-payment text-md-end">
                                <p>
                                    <img src="{{asset('public/frontend')}}/img/footer/footer-pay.png" alt="">
                                </p>
                            </div>
                        </div>
                    </div>
