                                            ...
                                            <div class="col-xl-10">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="tp-product-details-desc-content pt-25">
                                                                ...
                                                                <p>With a slim design, a vibrant entertainment system, and
                                                                    <br> outstanding performance, the new Galaxy Tab A7 is a
                                                                    stylish new <br> companion for your life.Dive head-first
                                                                    into the things you love, <br> and easily share your
                                                                    favorite moments. Learn, explore, connect <br> and be
                                                                    inspired.</p>
                                                            </div>
                                                            <div class="tp-product-details-desc-content">
                                                                ...
                                                                <p>S Pen is a bundle of writing instruments in one. Its
                                                                    natural grip, <br> low latency and impressive pressure
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="tp-product-details-desc-thumb">
                                                                <img src="{{asset('public/frontend')}}/img/product/details/desc/product-details-desc-1.jpg"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="tp-product-details-desc-item  pb-75">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-7">
                                                            <div class="tp-product-details-desc-thumb">
                                                                <img src="{{asset('public/frontend')}}/img/product/details/desc/product-details-desc-2.jpg"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-5 order-first order-lg-last">
                                                            <div
                                                                ...
                                                                <h3 class="tp-product-details-desc-title">Carry with <br>
                                                                    Confidence and style</h3>
                                                                <p>Wrap your tablet in a sleek case that's as stylish as it
                                                                    is convenient. Galaxy Tab S6 Lite Book Cover folds
                                                                    around and clings magnetically, so you can easily gear
                                                                    up as you're headed out the door. There's even a
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-12">
                                                            <div class="tp-product-details-desc-banner text-center m-img">
                                                                ...
                                                                <img src="{{asset('public/frontend')}}/img/product/details/desc/product-details-desc-3.jpg"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </div>
